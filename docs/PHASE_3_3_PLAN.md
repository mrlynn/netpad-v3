...
### Step 1: Extract Templates to JSON (2-3 days)
- [ ] Create template directory structure
- [ ] Export form templates to JSON files
- [ ] Export workflow templates to JSON files
- [ ] Create template loader utility
- [ ] Update EmptyFormState to use loader
- [ ] Test template loading

### Step 2: Create Gallery Components (3-4 days)
- [ ] Create TemplateCard component
- [ ] Create CategoryFilter component
- [ ] Create TemplatePreview component
- [ ] Create TemplateGallery wrapper
- [ ] Add search functionality (basic)
- [ ] Style and polish

### Step 3: Add Preview & Customization (2-3 days)
- [ ] Enhance TemplatePreview with field/node preview
- [ ] Add "Use Template" vs "Customize" options
- [ ] Implement customization flow
- [ ] Add template metadata (complexity, time, requirements)
- [ ] Test preview functionality

### Step 4: Integration (2-3 days)
- [ ] Integrate TemplateGallery into EmptyFormState
- [ ] Integrate TemplateGallery into EmptyWorkflowState
- [ ] Handle template application (forms & workflows)
- [ ] Test end-to-end flow
- [ ] Remove old template code (if replacing)

### Step 5: Polish & Documentation (1-2 days)
