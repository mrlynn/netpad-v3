    ...
    <Card
      ...
      sx={{
        ...
        '&:after': {
          ...
          inset: 0,
          background:
            'radial-gradient(900px circle at 10% -20%, rgba(255,255,255,0.06), transparent 55%)',
          pointerEvents: 'none',
          opacity: 1,
        },
        '&:hover': {
    ...
    >
      <CardContent sx={{ position: 'relative', p: { xs: 2.5, md: 3 } }}>
        <Stack spacing={1.25}>
          <Stack direction="row" spacing={1.25} alignItems="center">
            ...
            <Box>
              {eyebrow ? (
                <Typography
                  variant="caption"
                  sx={{ color: 'rgba(255,255,255,0.65)', letterSpacing: 0.4 }}
                >
                  {eyebrow}
                </Typography>
              ) : null}
          ...
          <Box sx={{ color: 'rgba(255,255,255,0.80)' }}>{children}</Box>
        </Stack>
      </CardContent>
    </Card>
  );
